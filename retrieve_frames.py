"""Frame Retrieval experiment, top-k"""
import os
import math
import itertools
import argparse
...
from datasets.ucf101 import UCF101FrameRetrievalDataset
...
def topk_retrieval(args):
    ...
    for k in ks:
        ...
        total = len(X_test)
        print('Top-{}, correct = {:.2f}, total = {}, acc = {:.2f}'.format(k, correct, total, correct/total))
